...
#     product = models.ForeignKey(Product, on_delete=models.SET_NULL, null=True)  # Link to vendor's Product
#     quantity = models.FloatField()
#     unit_price = models.FloatField()  # This will use selling_price from Product
#     total_price = models.FloatField()

#     def __str__(self):
#         return f"{self.product.product_name} - {self.invoice}"
